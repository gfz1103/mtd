...
//	@SuppressWarnings("hiding")
    ...
    public static String getPersonAgeStr(Date birthday) {
        return (String) getPersonAge(birthday, null).get("ages");
    }
...
//			newKey = newKey.replace("_", "");
    ...
    public static double doubletwo(double dou) {
        double re = new BigDecimal(Double.toString(dou)).setScale(2, BigDecimal.ROUND_HALF_UP)
                .doubleValue();
        return re;
    }
