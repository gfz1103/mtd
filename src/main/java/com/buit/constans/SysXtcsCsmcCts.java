...
/*    //治疗医嘱当天全部执行时间点，预约时间若小于此时间点，则认为该天该医嘱各个频次时间点均可执行；否则即认为即认为只有大于预约时间的可执行
    public static final String QBZXSJ = "QBZXSJ";*/

    //康复治疗执行天数限制,不能超过当前时间后多少天, 默认1(可以执行明天的任务)
    public static final String TREATMENT_EXECUTE_DAYS_LIMIT = "ZLZXTSXZ";
}
