 ...
 * @author zhouhaisheng
 */
@ApiModel(value = "住院记账病人退费分页查询")
public class SsZytfQueryPageResp extends PageQuery {
    ...
    @ApiModelProperty(value = "已退费金额")
    private BigDecimal ytfje;
    ...
    public BigDecimal getYtfje() {
        return ytfje;
    }

    public void setYtfje(BigDecimal ytfje) {
        this.ytfje = ytfje;
    }
}