 ...
 * 类描述：治疗申请单明细表
 * @author ZHOUHAISHENG
 * @ApiModel(value="治疗申请单明细表")
 */
public class ZlSqdmx  extends  PageQuery{
    ...
    @ApiModelProperty(value="预约时段（开始）【08:00】")
    private String yysdks;
    @ApiModelProperty(value="预约时段（结束）【09:30】")
    private String yysdjs;
    @ApiModelProperty(value="是否预约 1是 0否")
    private String sfyy;
    @ApiModelProperty(value="类型 1临时2长期")
    private String lx;
