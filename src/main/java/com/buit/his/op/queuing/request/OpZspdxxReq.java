...
public class OpZspdxxReq  extends  PageQuery{
    @ApiModelProperty(value="唯一ID,使用描述:新增时不可传递到后台，修改时必须传递到后台", hidden = true)
    private Integer oid;
    @ApiModelProperty(value="数据版本,使用描述:新增时不可传递到后台，修改时必须传递到后台", hidden = true)
    private Integer sjbb;
    @ApiModelProperty(value="数据创建时间", hidden = true)
    private Timestamp cjsj;
    @ApiModelProperty(value="数据修改时间", hidden = true)
    private Timestamp xgsj;
    @ApiModelProperty(value="医疗机构ID,使用描述:创建时不可为空", hidden = true)
    private Integer jgid;
    @ApiModelProperty(value="门诊就诊号", hidden = true)
    private String mzjzh;
    @ApiModelProperty(value="挂号时间，使用描述：格式为yyyy-MM-dd HH:mm:ss")
    private Timestamp ghsj;
    @ApiModelProperty(value="时间段代码(班次)", hidden = true)
    private String sddm;
    @ApiModelProperty(value="科室id", hidden = true)
    private Integer ksid;
    @ApiModelProperty(value="号类字典代码", hidden = true)
    private String hlzddm;
    @ApiModelProperty(value="挂号医生id", hidden = true)
    ...
    @ApiModelProperty(value="排队序号", hidden = true)
    private Integer pdxh;
    @ApiModelProperty(value="叫号时间，使用描述：格式为yyyy-MM-dd HH:mm:ss", hidden = true)
    private Timestamp jhsj;
    @ApiModelProperty(value="叫号科室ID", hidden = true)
    private Integer jhks;
    @ApiModelProperty(value="叫号医生ID", hidden = true)
    private Integer jhys;
    @ApiModelProperty(value="叫号诊室代码", hidden = true)
    private String jhksdm;
    @ApiModelProperty(value="就诊标志，使用描述：FD 0-第一次,1-二次就诊,2-转诊", hidden = true)
    private String jzbz;
    @ApiModelProperty(value="就诊状态，使用描述：FD 0-待诊,1-诊中,2-诊毕", hidden = true)
    private String jzzt;
    @NotBlank(message = "叫号诊台代码 不能为空")
    @ApiModelProperty(value="叫号诊台代码")
    private String jhtdm;
    @ApiModelProperty(value="指定医生(护士操作)ID", hidden = true)
    private Integer zdys;
    @ApiModelProperty(value="叫号次数,适用描述：超过指定次数则叫号序号变为当前队列最后", hidden = true)
    private Integer jhcs;
    @ApiModelProperty(value="调整标志,适用描述：1-急，2-过号重排，0-正常，-1-后移，3-叫号不应", hidden = true)
    private Integer tzbz;
    @ApiModelProperty(value="指定诊室(护士操作)代码", hidden = true)
    private String zdksdm;
    @ApiModelProperty(value="号失效时间，挂号时间+号类的有效时长", hidden = true)
    private Timestamp sxsj;
    @ApiModelProperty(value="病人分级", hidden = true)
    private String brfj;
    @ApiModelProperty(value="病人id", hidden = true)
    private Integer brid;
    @ApiModelProperty(value="就诊流水号", hidden = true)
    private String jzlsh;
    @ApiModelProperty(value="病人姓名或者病人卡号")
    private String brxm;
    @ApiModelProperty(value="病人卡号", hidden = true)
    private String brkh;
    @ApiModelProperty(value="出生日期", hidden = true)
    private Date csrq;
    @ApiModelProperty(value="性别", hidden = true)
    private String xb;
    @ApiModelProperty(value="收费性质", hidden = true)
    private String sfxz;
    @ApiModelProperty(value="病人类型 1：预约", hidden = true)
    private String brlx;
    /**
