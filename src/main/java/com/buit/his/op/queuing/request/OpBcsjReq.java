...
public class OpBcsjReq  extends  PageQuery{
    ...
    @ApiModelProperty(value="时段代码", hidden = true)
    private String sddm;
    @ApiModelProperty(value="时段名称", hidden = true)
    private String sdmc;
    @NotBlank(message = "上班时间 不能为空")
    @ApiModelProperty(value="上班时间 HH24:MI:SS")
    private String sbsj;
    @NotBlank(message = "下班时间 不能为空")
